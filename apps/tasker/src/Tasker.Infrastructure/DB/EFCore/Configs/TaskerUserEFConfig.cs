...
{
    public class TaskerUserEFConfig : BaseIdentityEFConfig<TaskerUser> //BaseEntityEFConfig<User>
    {
        //public TaskerUserEFConfig(string? tableName = "User") : base(tableName) { }
        public TaskerUserEFConfig() : base() { }

        public override void Configure(EntityTypeBuilder<TaskerUser> builder)
        {
