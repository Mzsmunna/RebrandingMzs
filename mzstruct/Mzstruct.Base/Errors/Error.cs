...
namespace Mzstruct.Base.Errors
{
    public sealed record Error(ErrorType Type, string Code, string Message, int StatusCore = 102, string Url = "", string Title = "", string Detail = "")
    {
        ...
        public static Error Missing(string code = "", string message = "") => new(ErrorType.Missing, code, message, 404, "https://www.rfc-editor.org/rfc/rfc9110#name-404-not-found", "404-missing");
        ...
        public static Error Validation(string code = "", string message = "") => new(ErrorType.Validation, code, message, 422, "https://www.rfc-editor.org/rfc/rfc9110#name-422-unprocessable-content", "422-unprocessable-content");
